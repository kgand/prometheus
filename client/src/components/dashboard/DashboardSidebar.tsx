  ...
  return (
    <>
          ...
          <div className="py-6 text-sm">
            ...
            <div className="border-b border-gray-300 px-3 pt-4 pb-3">
              ...
              <ul className="mt-2 grid gap-1 text-[#404040]">
                <Link to={"/dashboard/mapview"} className="flex cursor-pointer items-center gap-2 overflow-x-hidden rounded-md px-3 py-1 whitespace-nowrap transition-all hover:bg-gray-200">
      ...
      <>
        {!isOpen && (
          <div
            className="group absolute z-10 top-0 left-0 m-3 flex cursor-pointer items-center justify-center rounded-lg bg-gray-300 p-2 transition-all hover:bg-gray-400"
